            ...
            <div className={`px-3 py-3 bg-white border border-black/[0.06] rounded-xl mb-2 transition-opacity ${!album.is_visible ? 'opacity-40' : ''}`}>
              {editingId === album.id ? (
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button onClick={() => toggleFeaturedHome(album)} className="text-black/25 hover:text-amber-500 p-1" title="首页精选">
                    {album.is_featured_home ? <MdOutlineStar size={17} className="text-amber-500" /> : <MdOutlineStarOutline size={17} />}
                  </button>
