...
export default function Library() {
  ...
  const tagButtonStyle = (tag: string) => {
    ...
    return {
      ...
      background: state === 'include' ? '#1a1a1a' : state === 'exclude' ? '#fee2e2' : '#f5f5f3',
      color: state === 'include' ? '#fff' : state === 'exclude' ? '#ef4444' : '#666',
      borderColor: state === 'include' ? '#1a1a1a' : state === 'exclude' ? '#fca5a5' : '#e8e8e6',
