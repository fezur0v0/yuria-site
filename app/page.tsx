      ...
      <style>{`
        ...
        *{box-sizing:border-box}
        ...
        @media(max-width:768px){
          ...
          .port-img-wrap{order:4;width:100%!important;aspect-ratio:16/9}  /* 手机端也是16:9 */
        ...
        <main className="main-area">
          ...
          <div className="player-wrap sr" style={{ padding: '0 56px', borderBottom: '0.5px solid #efefed' }} data-d="0">
            ...
            >
              {tracks.map((t, i) => (
                ...
                >
                  <span style={{ fontSize: '10px', color: '#ccc', width: '18px', textAlign: 'center', flexShrink: 0 }}>
                    {i + 1}
                  </span>
          ...
          <div className="sr content-wrap" style={{ padding: '52px 56px 72px' }} data-d="140">
            ...
            <button
              ...
              onMouseEnter={(e) => {
                ;(e.currentTarget as HTMLElement).style.background = 'rgba(26,26,26,.08)'
                ;(e.currentTarget as HTMLElement).style.boxShadow = '0 8px 32px rgba(0,0,0,.06)'
              }}
              onMouseLeave={(e) => {
                ;(e.currentTarget as HTMLElement).style.background = 'rgba(26,26,26,.04)'
                ;(e.currentTarget as HTMLElement).style.boxShadow = 'none'
              }}
            >
              <div
      ...
      {pwOpen && (
        ...
        >
          ...
          >
            ...
            <div style={{ fontSize: '11px', color: '#bbb', letterSpacing: '.1em', marginBottom: '32px' }}>私密空间 · 请输入密码</div>

            {pwErr && <p style={{ fontSize: '12px', color: '#c0392b', marginBottom: '12px' }}>{pwErr}</p>}
            ...
            <button
              ...
              onMouseEnter={(e) => {
                if (!checking) (e.currentTarget as HTMLElement).style.background = '#383838'
              }}
              onMouseLeave={(e) => {
                if (!checking) (e.currentTarget as HTMLElement).style.background = '#1a1a1a'
              }}
            >
              {checking ? '验证中…' : '进 入'}
            </button>
